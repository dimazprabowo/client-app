                        ...
                        <div class="flex items-center space-x-1 flex-shrink-0">
                            ...
                            @if($notification->action_url)
                                <a href="{{ $notification->action_url }}"
                                   wire:navigate
                                   @click="loadingId = {{ $notification->id }}"
                                   ...
                                   class="p-1.5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                                    <svg x-show="loadingId !== {{ $notification->id }}" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                                    </svg>
                                    <svg x-show="loadingId === {{ $notification->id }}" class="animate-spin w-4 h-4" fill="none" viewBox="0 0 24 24">
